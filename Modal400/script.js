modalProperty = {
  ...
  modalAction:
    document.querySelector(".Modal-400").lastElementChild.previousElementSibling
      .firstElementChild,
  closeModalAction1:
    document.querySelector(".Modal-400").lastElementChild.lastElementChild
      .firstElementChild,
  closeModalAction2:
    document.querySelector(".Modal-400").lastElementChild.firstElementChild
      .lastElementChild,
