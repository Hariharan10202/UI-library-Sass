const growInputProperty = {
  mainComponent: document.querySelector(".growInput"),
  inputFieldWidth: document.querySelector(".growInput").firstElementChild,
  mainInput:
    document.querySelector(".growInput").firstElementChild.lastElementChild,
  inputField:
    document.querySelector(".growInput").firstElementChild.lastElementChild
      .firstElementChild,
  autpopList:
    document.querySelector(".growInput").lastElementChild.lastElementChild,
  autpopLists: document.querySelector(".growInput").lastElementChild,
  individualList: document
    .querySelector(".growInput")
    .lastElementChild.lastElementChild.querySelectorAll(".ind-li"),
  listHeading:
    document.querySelector(".growInput").lastElementChild.firstElementChild,
  optionList: [],
  deSelectOptionList: () => {
    for (
      let index = 0;
