...
const panelForm = {
  mainComponent: document.querySelector(".panel-dropdown"),
  inputField: document.querySelector(".panel-dropdown").firstElementChild,
  mainInput:
    document.querySelector(".panel-dropdown").firstElementChild
      .lastElementChild,
  form: document.querySelector(".panel-dropdown").lastElementChild
    .previousElementSibling.firstElementChild,
  panelDropdown:
    document.querySelector(".panel-dropdown").lastElementChild
  ...
  tooltip: document.querySelector(".panel-dropdown").lastElementChild,
  panelFormDetailList: [],
  toggleDropdown: () => {
