const twolinemulcheckboxProp = {
  mainComponent: document.querySelector(".twoline-multiSelect-label"),
  inputField: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.firstElementChild,
  mainInput: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.firstElementChild.lastElementChild,
  doneBtn: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.lastElementChild.previousElementSibling.firstElementChild
    .lastElementChild,
  selectList: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.lastElementChild.previousElementSibling.firstElementChild
    .lastElementChild.previousElementSibling,
  selectLists: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.lastElementChild.previousElementSibling
    .firstElementChild,
  individualList: document
    .querySelector(".twoline-multiSelect-label")
    .firstElementChild.lastElementChild.previousElementSibling.firstElementChild.lastElementChild.previousElementSibling.querySelectorAll(
      ".ind-li"
    ),
  multiSelect: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild,
  innerInput: document.querySelector(".twoline-multiSelect-label")
    .firstElementChild.lastElementChild.previousElementSibling.firstElementChild
    .firstElementChild.firstElementChild,
  listHeading: document
    .querySelector(".twoline-multiSelect-label")
    .firstElementChild.querySelector(".li-head-wrap"),
  chip: document.querySelector(".twoline-multiSelect-label").firstElementChild
    .lastElementChild,
  chipCloseAction: document
    .querySelector(".twoline-multiSelect-label")
    .firstElementChild.querySelector(".chipCloseAction"),
  MultiSelectList: [],
