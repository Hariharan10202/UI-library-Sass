const autopopProperty = {
  mainComponent: document.querySelector(".autopop"),
  inputFieldWidth: document.querySelector(".autopop").firstElementChild,
  sample: this.inputFieldWidth,
  mainInput:
    document.querySelector(".autopop").firstElementChild.lastElementChild,
  inputField:
    document.querySelector(".autopop").firstElementChild.lastElementChild
      .lastElementChild.previousElementSibling,

  autpopList:
    document.querySelector(".autopop").lastElementChild.lastElementChild,
  autpopLists: document.querySelector(".autopop").lastElementChild,
  individualList: document
    .querySelector(".autopop")
    .lastElementChild.querySelectorAll(".ind-li"),
  listHeading:
    document.querySelector(".autopop").lastElementChild.firstElementChild,
  closeAction:
    document.querySelector(".autopop").firstElementChild.lastElementChild
      .lastElementChild,
  deSelectOptionList: () => {
